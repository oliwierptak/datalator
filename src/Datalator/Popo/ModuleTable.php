...
class ModuleTable 
{
  ...
  'sql' => '',
     ...
     * @param array $data
     *
     * @return \Datalator\Popo\ModuleTable
     */
    public function fromArray(array $data): \Datalator\Popo\ModuleTable
    {
        $result = [];
        foreach ($this->propertyMapping as $key => $type) {
            $result[$key] = null;
     ...
     * @return self
     */
    public function setName(?string $name): \Datalator\Popo\ModuleTable
    {
     ...
     * @return self
     */
    public function setSql(?string $sql): \Datalator\Popo\ModuleTable
    {
        $this->popoSetValue('sql', $sql);
    ...
    {
        $this->assertPropertyValue('sql');

        return (string)$this->popoGetValue('sql');
    }
